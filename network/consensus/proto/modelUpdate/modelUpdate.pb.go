...
type ModelUpdate struct {
	...
	Content  []float64 `protobuf:"fixed64,3,rep,packed,name=content,proto3" json:"content,omitempty"`
...
func (x *ModelUpdate) GetContent() []float64 {
	if x != nil {
		return x.Content
	}
	return nil
...
var file_modelUpdate_proto_rawDesc = []byte{
	...
	0x20, 0x03, 0x28, 0x01, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x1a, 0x0a,
